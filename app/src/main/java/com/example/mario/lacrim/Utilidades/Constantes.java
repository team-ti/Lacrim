...
public class Constantes {
    ...
    public static final String CAMPO_NOMBRE_USER_SOLICITUD="nombre_solicitud";
    public static final String CAMPO_ID_USER_RECEPTOR_SOLICITUD="id_user_receptor";
    ...
    public static final String CREAR_TABLA_SOLICITUD="CREATE TABLE " +
            ...
            +CAMPO_ID_EQUINO_SOLICITUD+" INTEGER, "+CAMPO_ID_USER_SOLICITUD+" INTEGER, "+CAMPO_ID_PESEBRERA_SOLICITUD+" INTEGER, "+CAMPO_ID_USER_RECEPTOR_SOLICITUD+" INTEGER, "+CAMPO_NOMBRE_USER_SOLICITUD+" TEXT)";
